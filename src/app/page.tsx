  ...
  return (
    <main className="max-w-lg mx-auto p-6">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold">🔥 ChallengeUp</h1>
        <Link href="/create"
      ...
      <div className="space-y-3">
        ...
        {bets.map(bet => (
          <Link key={bet.id} href={`/bet/${bet.id}`}>
            <div className="border rounded-xl p-4 hover:border-black transition-colors cursor-pointer">
              <h2 className="font-semibold text-lg">{bet.title}</h2>
